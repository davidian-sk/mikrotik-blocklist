...
### Rotation Script (check and adapt your storage paths and locations)
...
add action=drop chain=prerouting dst-address-list=davidian-sk-blocklist-out_a dst-address=!224.0.0.0/4 dst-address-type=!broadcast comment="RAW-SEC: Drop outbound traffic to malicious blocklist"
```
